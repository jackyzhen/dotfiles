...
(use-package counsel
  ...
  (progn
    ...
    (setq counsel-rg-base-command "rg -i -g '!.git/*' --glob \!po/ --glob \!l10n/ --glob \!node-modules/ --glob \!node-scripts/ --glob \!flow-typed/ --glob \!coverage/ --glob \!vendors/ --glob \!vendor/ --no-heading --line-number --hidden --max-columns 512 --color never %s .")
